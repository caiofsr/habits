...
import { api } from "@habits/backend/convex/_generated/api";
import type { Id } from "@habits/backend/convex/_generated/dataModel";
						...
						<View className="mb-6">
							<View className="mb-2 flex-row items-center space-x-2">
								...
								<TouchableOpacity
									...
									className={`rounded-md px-4 py-2 ${!newTodoText.trim() ? "bg-muted" : "bg-primary"}`}
								>
								...
								{todos.map((todo) => (
									...
									>
										<View className="flex-1 flex-row items-center">
											<TouchableOpacity onPress={() => handleToggleTodo(todo._id, todo.completed)} className="mr-3">
												<Ionicons
